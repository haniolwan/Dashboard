...
const Filter = ({ tableCols, setTableCols, icon, show, setShow }) => {
  ...
  return (
    <ul
      ...
      } sidebar !overflow-auto max-h-[16rem] z-10 absolute px-6 rounded-lg top-14 rtl:right-auto rtl:left-2 right-2 w-[11rem] h-[15rem] flex flex-col items-center gap-4 bg-white dark:bg-gray-800`}
    >
